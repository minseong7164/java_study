...
public class Main {
    public static void main(String[] args) {
        // 람다식을 정의 할 때 꼭 지켜야하는 조건 -> 무조건 하나의 추상 메소드만 정의해야한다. 두개이상부터 불가능
        ...
        // 재정의 함수 내용이 한줄의 명령이면 {}중괄호를 생략할 수 있다. 2줄이상이면 무조건 중괄호가 있어야한다.
        // 단, 리턴이 있는 경우 리턴 값만 한줄로 작성해야한다.
        아무거나가능한인터페이스 g = () -> System.out.println("한줄 명령");
